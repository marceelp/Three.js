...
import { DimensionGUIHelper, MinMaxGUIHelper, VisibleGUIHelper } from "./classes";
...
camera.lookAt(-20, 0, -50)

const controls = new OrbitControls(camera, renderer.domElement);
controls.target.set(0, 5, 0);

{
  const light = new THREE.HemisphereLight(0xb1e1ff, 0xb97a20, 0.6);
  scene.add(light);
}
...
const tick = (time) => {
...

  {
    ...
    cars.forEach((car, i) => {
      ...
      const u = pathTime + i / cars.length;
